package sg.com.uicomponent_conversationwindow.camera;
...
import sg.com.uicomponent_conversationwindow.utils.ServiceUtil;
...
public class QuickAttachmentDrawer extends ViewGroup implements InputAwareLayout.InputView, CameraView.CameraViewListener {
  ...
  private void updateControlsView() {
    ...
    if (cameraView.isMultiCamera()) {
      ...
      swapCameraButton.setImageResource(cameraView.isRearCamera() ? R.drawable.ic_camera_front_white_36dp
  ...
  private void setDrawerState(DrawerState drawerState) {
    switch (drawerState) {
    case COLLAPSED:
      fullScreenButton.setImageResource(R.drawable.ic_fullscreen_white_36dp);
      break;
    case HALF_EXPANDED:
      if (isLandscape()) {
      ...
      break;
    case FULL_EXPANDED:
      fullScreenButton.setImageResource(isLandscape() ? R.drawable.ic_keyboard_arrow_down_white_36dp

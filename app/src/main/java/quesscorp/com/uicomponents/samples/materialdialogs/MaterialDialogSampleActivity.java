package quesscorp.com.uicomponents.samples.materialdialogs;
...
import quesscorp.com.uicomponent_materialdialogs.core.DialogAction;
import quesscorp.com.uicomponent_materialdialogs.core.GravityEnum;
import quesscorp.com.uicomponent_materialdialogs.core.MaterialDialog;
import quesscorp.com.uicomponent_materialdialogs.core.StackingBehavior;
import quesscorp.com.uicomponent_materialdialogs.core.Theme;
import quesscorp.com.uicomponent_materialdialogs.core.internal.MDTintHelper;
import quesscorp.com.uicomponent_materialdialogs.core.internal.ThemeSingleton;
import quesscorp.com.uicomponent_materialdialogs.core.util.DialogUtils;
import quesscorp.com.uicomponent_materialdialogs.commons.color.CircleView;
import quesscorp.com.uicomponent_materialdialogs.commons.color.ColorChooserDialog;
import quesscorp.com.uicomponent_materialdialogs.commons.folderselector.FileChooserDialog;
import quesscorp.com.uicomponent_materialdialogs.commons.folderselector.FolderChooserDialog;
import quesscorp.com.uicomponent_materialdialogs.commons.simplelist.MaterialSimpleListAdapter;
import quesscorp.com.uicomponent_materialdialogs.commons.simplelist.MaterialSimpleListItem;
import quesscorp.com.uicomponents.R;

/**
 * @author Aidan Follestad (afollestad)
 */
public class MaterialDialogSampleActivity extends AppCompatActivity
    ...
    public static Intent newIntent(Context mContext) {
        Intent intent = new Intent(mContext, MaterialDialogSampleActivity.class);
        return intent;
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_material_dialog_sample);
    ...
    public void showMultiChoiceLimitedMin() {
        new MaterialDialog.Builder(this)
                ...
                .itemsCallbackMultiChoice(
                        new Integer[]{1}, new MaterialDialog.ListCallbackMultiChoice() {
                            @Override
                            public boolean onSelection(MaterialDialog dialog, Integer[] which, CharSequence[] text) {
                                boolean allowSelectionChange =
                                        which.length
    ...
    public void showMultiChoiceLongItems() {
        new MaterialDialog.Builder(this)
                ...
                .items(R.array.socialNetworks_longItems)
                .itemsCallbackMultiChoice(
                        new Integer[]{1, 3}, new MaterialDialog.ListCallbackMultiChoice() {
                            @Override
                            public boolean onSelection(MaterialDialog dialog, Integer[] which, CharSequence[] text) {
                                StringBuilder str = new StringBuilder();
                                for (int i = 0; i < which.length; i++) {
    ...
    public void showMultiChoiceDisabledItems() {
        new MaterialDialog.Builder(this)
                ...
                .items(R.array.socialNetworks)
                .itemsCallbackMultiChoice(
                        new Integer[]{0, 1, 2}, new MaterialDialog.ListCallbackMultiChoice() {
                            @Override
                            public boolean onSelection(MaterialDialog dialog, Integer[] which, CharSequence[] text) {
                                StringBuilder str = new StringBuilder();
                                for (int i = 0; i < which.length; i++) {
    ...
    public void showFileChooser() {
        ...
        if (ActivityCompat.checkSelfPermission(
                MaterialDialogSampleActivity.this, Manifest.permission.READ_EXTERNAL_STORAGE)
                != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(
                    MaterialDialogSampleActivity.this,
    ...
    public void showFolderChooser() {
        ...
        if (ActivityCompat.checkSelfPermission(
                MaterialDialogSampleActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE)
                != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(
                    MaterialDialogSampleActivity.this,
        ...
        new FolderChooserDialog.Builder(MaterialDialogSampleActivity.this)

...
public class PhotoViewSampleActivity extends AppCompatActivity {

    public static Intent newIntent(Context mContext) {
        Intent intent = new Intent(mContext, PhotoViewSampleActivity.class);
        return intent;
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_photoview_sample);
